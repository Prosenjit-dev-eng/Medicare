...
export const navbarStyles = {
  ...
  flexContainer: "flex items-center justify-between gap-6",
  
  // Logo section styles
  logoContainer: "flex items-center gap-4",
  logoImageWrapper: "flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-md border border-emerald-100",
  logoImage: "h-12 w-12 object-cover",
  logoTextContainer: "flex flex-col leading-tight",
  logoLink: "text-2xl font-bold text-emerald-700",
  logoSubtext: "text-xs text-gray-500",
  
  // Center navigation
  centerNavContainer: "flex-1 flex items-center justify-center",
  glowEffect: "relative rounded-full p-1 bg-gradient-to-r from-emerald-100 via-emerald-200 to-emerald-100 shadow-sm",
  centerNavInner: "relative flex items-center",
  centerNavScrollContainer: "flex items-center gap-2 overflow-x-auto rounded-full bg-white px-3 py-2 shadow-lg border border-gray-100",
  
  // Center nav items
  centerNavItemBase: "inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-all duration-200",
  centerNavItemActive: "bg-emerald-50 text-emerald-700 shadow-sm",
  centerNavItemInactive: "text-gray-700 hover:bg-emerald-50 hover:text-emerald-700",
