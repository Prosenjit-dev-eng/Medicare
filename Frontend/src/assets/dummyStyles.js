...
export const navbarStyles = {
  ...
  logoContainer: "relative group w-20 h-20 sm:w-24 sm:h-24 lg:w-24 lg:h-24 xl:w-32 xl:h-32",
  logoImageWrapper: "relative flex items-center justify-center overflow-hidden p-2 mx-1 h-full w-full",
  logoImage: "w-14 h-14 sm:w-18 sm:h-18 md:w-20 md:h-20 lg:w-20 lg:h-20 xl:w-24 xl:h-24 object-contain",
  ...
  // Mobile menu
  mobileMenu: "absolute right-4 top-full mt-2 w-[90vw] max-w-sm rounded-3xl bg-white shadow-2xl border border-emerald-100 p-4 space-y-2 lg:hidden z-40",
  mobileMenuItem: "block px-4 py-3 rounded-2xl text-sm font-semibold transition-all duration-300 text-left",
